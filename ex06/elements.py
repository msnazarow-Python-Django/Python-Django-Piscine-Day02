...
class Html(Elem):
	...
	def is_valid(self):
		if type(self.content) == list and len(self.content) == 2:
			if isinstance(self.content[0], Head) and isinstance(self.content[1], Body):
				return self.content[0].is_valid() and self.content[1].is_valid()
		return False
...
class Head(Elem):
	...
	def is_valid(self):
		if type(self.content) == list and len(self.content) == 1 and isinstance(self.content[0], Title):
			return self.content[0].is_valid()
		elif isinstance(self.content, Title):
	...
	def is_valid(self):
		...
		if type(self.content) == list:
			for elem in self.content:
				if not isinstance(elem, (H1, H2, Div, Table, Ul, Ol, Span, Text)) or not elem.is_valid():
					return False
			return True
		return self.content.is_valid()
...
class Title(Elem):
	...
	def is_valid(self):
		if type(self.content) == list and len(self.content) == 1:
			return isinstance(self.content[0], Text)
...
class Table(Elem):
	...
	def is_valid(self):
		if type(self.content) == list and len(self.content) != 0:
			for elem in self.content:
				if not isinstance(elem, Tr) or not elem.is_valid():
					return False
			return True
		elif isinstance(self.content, Tr):
			return self.content.is_valid()
		return False
...
class Tr(Elem):
	...
	def is_valid(self):
		if type(self.content) == list and len(self.content) > 0:
			if not isinstance(self.content[0], (Th, Td)):
				return False
			for elem in self.content:
				if not isinstance(elem, type(self.content[0])) or not elem.is_valid():
					return False
			return True
		elif isinstance(self.content, (Th, Td)):
			return self.content.is_valid()
		return False
...
class Ul(Elem):
	...
	def is_valid(self):
		if type(self.content) == list and len(self.content) > 0:
			for elem in self.content:
				if not isinstance(elem, Li) or not elem.is_valid():
					return False
			return True
		elif isinstance(self.content, Li):
			return self.content.is_valid()
		return False
...
class P(Elem):
	...
	def is_valid(self):
		...
		if type(self.content) == list:
			for elem in self.content:
				if not isinstance(elem, Text) or not elem.is_valid():
					return False
			return True
		return isinstance(self.content, Text)
...
class Span(Elem):
	...
	def is_valid(self):
		if type(self.content) == list and len(self.content) > 0:
			for elem in self.content:
				if not isinstance(elem, (Text, P)) or not elem.is_valid():
					return False
			return True
		elif isinstance(self.content, (Text, P)):
			return self.content.is_valid()
		return False
